...
final class WAChartView: WABaseView {
    ...
    func configure(with data: [WALineChartView.Data], topChartOffset: CGFloat) {
        ...
        layoutIfNeeded()
        drawDashLines()
        drawLineChart(with: data, topChartOffset: topChartOffset)
    }
    
}


extension WAChartView {
...
private extension WAChartView {
    ...
    func drawLineChart(with data: [WALineChartView.Data], topChartOffset: CGFloat) {
